    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              ...
              <Button onClick={handleAddToCart} variant='contained' sx={{ px: "2rem", py: "1rem", bgcolor: "#0012BC", mt: 5 }}>
                Add to Cart
              </Button>

              <Button onClick={handleBuyNow} variant='contained' sx={{ px: "2rem", py: "1rem", bgcolor: "#C8201D", mt: 5, ml: 2 }}>
                Buy Now
              </Button>
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              <h1 className="text-lg lg:text-xl font-semibold text-grey-900 text-left">Surhi </h1>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='ml-3 text-sm font-medium text-blue-900 hover:text-blue-500'>3870 Reviews</p>
                </div>
              ...
              <form className="mt-10">
                {/* Colors */}
                <div>
                  <h3 className="text-sm font-medium text-gray-900 text-left">Color</h3>
                ...
                <Typography className="mt-8 text-lg text-left">Available offers</Typography>
                <SmallText>
                  ...
                  <ColumnText>
                    <TableCell style={{ color: '#878787' }}>GST</TableCell>
                    <TableCell>
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
              ...
              <div>
                ...
                <h2 className="text-sm font-medium text-gray-900 text-left mb-2">Description</h2>
              ...
              <div className="mt-10">
                <h3 className="text-sm font-medium text-gray-900 text-left">Product Details</h3>
              ...
              {/* <div className="mt-10">
              <h2 className="text-sm font-medium text-gray-900 text-left">Specification</h2>
              ...
              <Table>
                <TableBody>
                  <ColumnText>
                    <TableCell style={{ color: '#878787' }}>Ideal For</TableCell>
                    <TableCell>Men</TableCell>
                  </ColumnText>
                  <ColumnText>
                    <TableCell style={{ color: '#878787' }}>Pack of</TableCell>
                    <TableCell>1</TableCell>
                  </ColumnText>
                  <ColumnText>
                    <TableCell style={{ color: '#878787' }}>Fabric</TableCell>
                    <TableCell> Pure Cotton</TableCell>
                  </ColumnText>
                  <ColumnText>
                    <TableCell style={{ color: '#878787' }}>Occasion</TableCell>
                    <TableCell>Regular</TableCell>
                  </ColumnText>
                  <ColumnText>
                    <TableCell style={{ color: '#878787' }}>Fabric Care</TableCell>
                    <TableCell>Regular Machine Wash</TableCell>
                  </ColumnText>
                  <ColumnText>
                    <TableCell style={{ color: '#878787' }}>Pattern</TableCell>
                    <TableCell>Checkered</TableCell>
                  </ColumnText>
                  <ColumnText>
                    <TableCell style={{ color: '#878787' }}>Suitable For</TableCell>
                    <TableCell>Western Wear</TableCell>
                  </ColumnText>
        ...
        <section className='pt-10'>
          ...
          <h1 className="left-align font-semibold text-lg pb-4">Similar Products</h1>
